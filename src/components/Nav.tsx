...
export function Nav({isVisualizationRunningRef}: {isVisualizationRunningRef: MutableRefObject<boolean>}) {
    ...
    return (
        <div className="flex flex-col items-center justify-center shadow-gray-600 sm:px-5 px-0 gap-10">
            <h1 className="flex w-[100%] justify-center text-3xl md:text-5xl underline text-white font-mono mt-10 cursor-default select-none">
